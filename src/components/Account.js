...
const Account = () => {
  return (
    <div>
      ...
      <div>
      <button className='readmored'><Link to={"/Signuppage"} style={{color:"white", textDecoration:"none"}}>Sign up</Link></button>
      <button className='readmoref'><Link to={"/Loginpage"} style={{color:"white", textDecoration:"none"}}>Log in</Link></button>
      </div>
      <div>
